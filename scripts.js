const DURATIONS = {
    "12h": ["12 ч.", 12 * 3600, 75, 50],
    "24h": ["24 ч.", 24 * 3600, 150, 100],
    "3d": ["3 дн.", 3 * 86400, 300, 250],
    "7d": ["7 дн.", 7 * 86400, 750, 725],
    "15d": ["15 дн.", 15 * 86400, 2500, 2000],
    "30d": ["30 дн.", 30 * 86400, 4500, 3750],
    "6m": ["6 мес.", 6 * 30 * 86400, 22500, 20000],
    "1y": ["1 год", 365 * 86400, 45000, 40000]
};
